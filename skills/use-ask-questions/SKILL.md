...
description: Defines when and how to use the ask_questions tool. Load when about to ask the user a question, seek confirmation, after editing files, when all tasks are complete, or when executing a command.
---
...
5. **When executing a command** – explain the command details including all options and what each does, then call `ask_questions` to allow follow-up questions about the command
